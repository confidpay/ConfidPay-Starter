...
contract Counter {
    ...
    function allowPublicDecrypt() public {
        FHE.allowPublic(count);
    }

    function publishDecryptedValue(uint32 decryptedValue, bytes memory signature) public {
        FHE.publishDecryptResult(count, decryptedValue, signature);
    }
